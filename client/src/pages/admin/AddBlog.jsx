...
const AddBlog = () => {
  ...
  /* function for generating the AI content */
  ...
  /* function for the form to add data in database*/
  const onSubmitHandler = async (e) => {
    try {
      ...
      if(data.success) {
        ...
        //after adding the all data we have to clear that from the form so 
        setImage(false)
        setTitle('')
