...
const ListBlog = () => {
  ...
  /* state variables to store the blog data*/
  const [blogs, setBlogs] = useState([])
  const {axios} = useAppContext()


  //function to get the blog data from api and display on the admin dashboard
  const fetchBlogs = async () => {
    //setBlogs(blog_data)   this is fetching the data from assets
    try {
