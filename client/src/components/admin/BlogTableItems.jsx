...
const BlogTableItems = ({ blog, fetchBlogs, index }) => {
  ...
  //function to delete the blog from admin dashboard
  ...
  //function to make the blog published or unpublished
  ...
  //now link above these functions in the toggle and delete buttons
