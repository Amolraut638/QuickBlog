...
const BlogCard = ({blog}) => { /*  from this blog we will get the all blog data like name, discription, category etc */

    const { title, description, category, image, _id } = blog; /* destructuring the blog object to get the data */
